...
class VNC_POC(POCBase):
    ...
    def _verify(self):
        ...
        try:
            ...
            logger.info('[*] Could not connect to the target VNC service. Error code: ' + str(msg[0]) + ' , Error message : ' + msg[1])
